	...
	<tbody>
		<?php foreach ($query->result() as $row) : ?>
			<tr>
				...
				<td>
					<?php print cat_breadcrumb_ul_a($row->cat_id); ?>
				</td>
				<td>
				...
				<td>
					<a href="<?php print site_url('browse/download/' . $row->up_id); ?>" title="Downlaod this file!" target="_BLANK" class="icon_font">F</a>
				</td>
				<td>
