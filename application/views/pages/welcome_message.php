<?php $this->load->view('template/header'); ?>
	...
	<div id="body">
		...
		<p>
			Learn more about MI OWL by clicking on <a href="/about">“about”</a>.
			<br />
			Want to look through the existing OWL's and thier libraries? Click on <a href="/owls">“owl's”</a> above.
			<br />
			Searching for something specific?  Click on <a href="/search">“site search”</a> above.
			<br />
			Interested in learning how to create a new library?  Click on <a href="/about">“about”</a> and then click on <a href="/about/create_owl">“creating an OWL”</a>.   
			<br />
			Questions, or need support?  You can email us at <?php print safe_mailto('support@miowl.org'); ?>.
		</p>
	</div>
