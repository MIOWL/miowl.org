        ...
        $(function() {
            $('.catedit').click(function(e) {
                ...
                $.get('/owl/categories/select_list/' + cat_pid, function(response) {
                    ...
                    $('<div></div>').html('<p class="validateTips">All form fields are required.</p><fieldset><span class="left">Category Name</span><span id="dialog_name" class="text ui-widget-content ui-corner-all right" style="width: 185px;">' + cat_name + '</span><br /><span class="left">Sub Category</span><select name="subcat" id="dialog_subcat" class="select ui-widget-content ui-corner-all right">' + select_list + '</select>').dialog({
