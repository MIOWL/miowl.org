        ...
        <div id="owl_body" class="column right threequarter">
            ...
            <form action="" class="uniForm" method="post">
                ...
                <fieldset class="inlineLabels">
                    ...
                    <div class="ctrlHolder">
                        <label for="body">Message <span class="right">(required)</span></label>
                        <textarea name="body" id="body" size="35" class="textInput large" rows="5" cols="50"><?php print trim(set_value('body')); ?></textarea>
